...
//            pd.dismiss();
    ...
    JsonHttpResponseHandler GetListMedicalDogControllerPost = new JsonHttpResponseHandler() {
        @Override
...
//            pd.dismiss();
    ...
    private void GetListMedicalDog(){
        ...
        //отправка данных на сервер
        AsyncHttpClient client = new AsyncHttpClient();
        client.post(Service.UrlServer+"/GetListMedicalDogController", params, GetListMedicalDogControllerPost);
        pd.dismiss();
    }
    public class AdapterMedicalDog extends BaseAdapter {
        ...
        View.OnClickListener FabDeleteOnClickListener = new View.OnClickListener() {
            ...
            DialogInterface.OnClickListener AlertDialogPositiveButtonListener = new DialogInterface.OnClickListener() {
                ...
                AsyncHttpResponseHandler DeleteMedicalDogControllerPost = new AsyncHttpResponseHandler() {
                    @Override
                    public void onStart() {
...
//                        pd.dismiss();
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    //отправка данных на сервер
                    AsyncHttpClient client = new AsyncHttpClient();
                    client.post(Service.UrlServer + "/DeleteMedicalDogController", params, DeleteMedicalDogControllerPost);
                    pd.dismiss();
                }
            };
