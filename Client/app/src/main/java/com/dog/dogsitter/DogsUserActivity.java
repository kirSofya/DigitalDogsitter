...
public class DogsUserActivity extends AppCompatActivity {
    ListView ListViewDogs;
    AdapterMyDogs Adapter;
...
//            pd.dismiss();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dogs_user);
        ListViewDogs=findViewById(R.id.listViewDogsUser);
        FabAdd=findViewById(R.id.fabAddDogsUser);
    ...
    protected void onStart(){
        super.onStart();
        if(Service.FlagUpdate)GetListDogs();
    }
    //получение списка собак
    private void GetListDogs(){
        ProgressDialog pd;
...
//        View view;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null)convertView = mLayoutInflater.inflate(R.layout.list_my_dogs, null);
            ImageView image=convertView.findViewById(R.id.imageViewListMyDogs);
            TextView textViewName=convertView.findViewById(R.id.textViewNameListMyDogs);
            TextView textViewDateBirth=convertView.findViewById(R.id.textViewDateBirthListMyDogs);
            TextView textViewBreed=convertView.findViewById(R.id.textViewBreedListMyDogs);
            TextView textViewAge=convertView.findViewById(R.id.textViewAgeListMyDogs);
            FloatingActionButton fabDescription=convertView.findViewById(R.id.fabDescriptionListMyDogs);
            FloatingActionButton fabMedical=convertView.findViewById(R.id.fabMedicalListMyDogs);
            FloatingActionButton fabEdit=convertView.findViewById(R.id.fabEditListMyDogs);
            FloatingActionButton fabDelete=convertView.findViewById(R.id.fabDeleteListMyDogs);
            DataDog data=ListDogs.get(position);
            if(data.Image!=null){
                image.setImageBitmap(data.Image);
            }else{
                Bitmap bm = BitmapFactory.decodeResource(getResources(), R.drawable.no_image);
                image.setImageBitmap(Service.ScaleImage(30, bm));
            }
            textViewName.setText("Кличка: "+data.Name);
            textViewDateBirth.setText("Дата рождения: "+data.DateBirthText);
