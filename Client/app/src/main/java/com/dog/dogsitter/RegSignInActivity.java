...
public class RegSignInActivity extends AppCompatActivity {
    ...
    View.OnClickListener ButtonRegSignInOnClickListener = new View.OnClickListener() {

        String email;
        AsyncHttpResponseHandler RegSignInUserControllerPost = new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
...
//                pd.dismiss();
        ...
        public void onClick(View view) {
            String date_birth, password, name_controller="";
            ...
            client.post(Service.UrlServer+name_controller, params, RegSignInUserControllerPost);
            pd.dismiss();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonRegSignIn.setOnClickListener(ButtonRegSignInOnClickListener);
    }
}
