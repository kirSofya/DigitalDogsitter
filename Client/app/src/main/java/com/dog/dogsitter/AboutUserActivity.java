...
public class AboutUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Service.IdUser>0 && Service.IdUser!=IdUser){
            ...
            ButtonDoRating.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    client.post(Service.UrlServer+"/DoRatingDogsitterController", params, new AsyncHttpResponseHandler() {
                        @Override
